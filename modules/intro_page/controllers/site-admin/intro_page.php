...
class intro_page extends admin_controller {
	...
	function index() 
	{
		...
		$output['this_title_page'] = 'Intro Page';
	...
	public function intro_page_add()
	{
		...
		$output['this_title_page'] = 'Intro Page Add';
	...
	public function intro_page_edit( $id = '' )
	{
		...
		$output['this_title_page'] = 'Intro Page Edit';
		...
		if ( $this->input->post() ) 
		{
			...
			if ( empty( $output['error']  ) ) 
			{
				...
				$data_input['start_date'] = strtotime(reset_format_date( $data_input['start_date'] ));
				$data_input['end_date'] = strtotime(reset_format_date( $data_input['end_date'] ));
