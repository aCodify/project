			...
			<div class="portlet-body form">
                    ...
                    <div class="show_youtube_cover controls" >
                        ...
                        <?php if ( ! empty( $show_data['youtube_id_cover'] ) ): ?>
                            ...
                            <div class="box_show_youtube">
                                ...
                                <img class="show_img_youtube hover_video cursor_pointer fancybox.ajax" alt="" href="http://saha.dev/popup/youtube_url?data_video=<?php echo $json->data->player->default ?>" src="<?php echo $json->data->thumbnail->sqDefault ?>">
                                <div>
                ...
                <div class="control-group set_cover_video">
                    <label class="control-label">Cover video upload</label>
                        <div class="controls">
                            <span data-url="http://saha.dev/filemanager/video"  class="set_upload_file_video_cover btn green fileinput-button">
                                <i class="icon-plus icon-white"></i>
                            ...
                            <div class="upload_video_cover">
                                ...
                                <?php if ( ! empty( $show_data['file_video_cover'] ) ): ?>
		                            ...
		                            <div class="box_show_youtube box_show_video">
		                                ...
		                                <img class="show_img_youtube call_show_video cursor_pointer hover_video fancybox.ajax" href="http://saha.dev/popup?data_video=<?php echo $show_data['file_video_cover'] ?>" alt="" src="<?php echo $this->theme_path ?>image/my_video.png">
