                        ...
                        <tbody>
                            ...
                            <?php foreach ( $data_list as $key => $value ): ?>
                                ...
                                <tr class="">
                                                    ...
                                                    case '2':
                                                        ...
                                                        echo $html = '
                                                                <div class="main_c">
                                                                    <div class="tn_c">
                                                                        <a>
                                                                            <img class="show_img_youtube hover_video cursor_pointer fancybox.ajax" href="http://saha.dev/popup/youtube_url?data_video='.rawurlencode( $json->data->player->default ).'" src="'.$json->data->thumbnail->sqDefault.'" alt="" title="">
                                                                        </a>
                                                                    </div>
                                                                </div>';    
                                                    ...
                                                    case '3':
                                                        ...
                                                        echo $html = '
                                                                <div class="main_c">
                                                                    <div class="tn_c">
                                                                        <a>
                                                                            <img class="show_img_youtube hover_video cursor_pointer fancybox.ajax" href="http://saha.dev/popup?data_video='.$value->file_video_cover.'" src="'.$this->theme_path.'image/my_video.png" alt="" title="">
                                                                        </a>
                                                                    </div>
                                                                </div>';   
                                    ...
                                    <td><a class="" href="<?php echo site_url( 'site-admin/intro_page/intro_page_edit/'.$value->id ) ?>">Edit</a></td>
                                    <td><a data-url="<?php echo site_url( 'site-admin/intro_page/intro_page_delete/'.$value->id ) ?>" class="delete_data" href="javascript:;">Delete</a></td>
                                    <td>
