...
<!-- Not found text -->
	<div class="not-found-text">
        ...
        <!-- <h1 class="not-found-text">File not found, sorry! <a href="<?php echo site_url() ?>" class="with-tooltip" title="Return to the home page">Home</a> </h1>     -->
        
        <h1 class="not-found-text">Welcome to Home Page</h1>
