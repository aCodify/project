              ...
              <div class="controls">
                ...
                <div class="portlet-body-more">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <span data-url="http://saha.dev/filemanager/image"  class="set_upload_poster btn green fileinput-button">
                                <i class="icon-plus icon-white"></i>
                                <span>Add files...</span>
                            </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <span data-url="http://saha.dev/filemanager/image"  class="set_upload_promotion btn green fileinput-button">
                                <i class="icon-plus icon-white"></i>
                                <span>Add files...</span>
                            </span>
                ...
                <div class="portlet-body-more">
                    ...
                    <div class="control-group bb">
                        <label class="control-label">Background image upload</label>
                            <div class="controls">
                                <span data-url="http://saha.dev/filemanager/image"  class="set_upload_backgroud_image btn green fileinput-button">
                                    <i class="icon-plus icon-white"></i>
                                    <span>Add files...</span>
                                </span>
