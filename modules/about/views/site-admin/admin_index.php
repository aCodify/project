		...
		<div class="span12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<h4><i class="icon-edit"></i>About Data Table</h4>
				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							<a class="btn green" href="<?php echo site_url('site-admin/about/about_add') ?>"> 
						...
						<tbody>
							<?php foreach ( $data_list as $key => $info ): ?>
								...
								<tr class="">
									...
									<td><a class="" href="<?php echo site_url( 'site-admin/about/about_edit/'.$info->id ) ?>">Edit</a></td>
									<td><a data-url="<?php echo site_url('site-admin/about/about_delete/'.$info->id) ?>" class="delete_data" href="javascript:;">Delete</a></td>
								</tr>
