var App = function () {
    ...
    var ab_date_all = new Date();
    var ab_year = ab_date_all.getFullYear(); 
    ...
    var handleDateTimePickers = function () {
        ...
        // set maxDate
        ab_year = ab_year+5;
        var new_date = '12/31/'+ab_year;

        $('#form-date-range').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Tomorrow': ['today', Date.today().add({ days: 1 })],
                'Next 7 Days': [ 'today' , Date.today().add({
                    days: 6
                })],
                'Next 30 Days': [ 'today' , Date.today().add({
                    days: 29
                })],
                // 'This Month': [Date.today().moveToFirstDayOfMonth(), Date.today().moveToLastDayOfMonth()],
                'This Month': [ 'today' , Date.today().moveToLastDayOfMonth()],
                // 'Next Month': [ Date.today().moveToFirstDayOfMonth().add({
                //     months: -1
                // }), Date.today().moveToFirstDayOfMonth().add({
                //     days: -1
                // })]
                // 'Next Month': [ 'today' , Date.today().moveToLastDayOfMonth()]
            },
            opens: 'right',
            format: 'dd/MM/yyyy',
            separator: ' to ',
        ...
        function (start, end) {
            $('#form-date-range span').html(start.toString('d-MM-yyyy') + ' To ' + end.toString('d-MM-yyyy'));
        });
